...
while (!espSerial.find("ready")) {
timeOut++;
if (timeOut > 5) {
Serial.println("Timeout! Can't reset the Wi-Fi module, check your connections! I'll retry in 5 seconds...");
...
Serial.println("Can't turn on Multiple Connections!");
errCount++;
}

espSerial.println("AT+CIPSERVER=1,80");
if (!espSerial.find("OK")) {
Serial.println("Can't turn on Web Server!");
errCount++;
}
